...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "posts_slug_history" (
  	...
  	"reason" "enum_posts_slug_history_reason"
  );
  ...
  CREATE TABLE "_posts_v_version_slug_history" (
  	...
  	"slug" varchar,
  	"changed_at" timestamp(3) with time zone,
  	"reason" "enum__posts_v_version_slug_history_reason",
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "apikeys" (
  	...
  	"rate_limit_time_window" numeric DEFAULT 86400000,
  	"rate_limit_max" numeric DEFAULT 10,
  ...
  ALTER TABLE "posts" ADD CONSTRAINT "posts_folder_id_payload_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."payload_folders"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_folder_id_payload_folders_id_fk" FOREIGN KEY ("version_folder_id") REFERENCES "public"."payload_folders"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_apikeys_fk" FOREIGN KEY ("apikeys_id") REFERENCES "public"."apikeys"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "posts_folder_idx" ON "posts" USING btree ("folder_id");
  ...
  CREATE INDEX "_posts_v_version_version_folder_idx" ON "_posts_v" USING btree ("version_folder_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_apikeys_id_idx" ON "payload_locked_documents_rels" USING btree ("apikeys_id");
